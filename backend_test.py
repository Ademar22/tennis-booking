...
class TennisCourtAPITester:
    ...
    def test_admin_login_invalid(self):
        ...
        return self.run_test(
            ...
            "api/admin/login",
            401,
            data={"email": "admin@tenniscourt.com", "password": "wrongpassword"}
        )
    ...
    def test_get_availability(self):
        ...
        if success:
            ...
            if 'slots' in response and isinstance(response['slots'], list):
                ...
                # Check if we have slots for 3 courts
                courts = set()
    ...
    def test_create_booking(self):
        ...
        # Backend correctly returns 201 for created resource
        success, response = self.run_test(
            "Create Booking",
            "POST",
            "api/bookings",
    ...
    def test_get_all_bookings_no_auth(self):
        ...
        # SECURITY ISSUE: This endpoint currently doesn't require auth
        return self.run_test(
            "Get All Bookings (No Auth - SECURITY ISSUE)",
            "GET",
            "api/bookings",
            401,  # Should require auth but currently returns 200
            headers={}
        )
    ...
    def test_get_customer_bookings(self):
        ...
        success, response = self.run_test(
            ...
            "GET",
            "api/my-bookings/test@example.com",
            200
        )
...
def main():
    print("🎾 Tennis Court Booking API Test Suite")
    print("=" * 50)
